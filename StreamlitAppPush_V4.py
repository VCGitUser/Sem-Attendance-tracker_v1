...
# ─── ADD THIS PASSWORD SECURITY BLOCK AT THE TOP ───
def check_password():
...
def load_data():
    df = pd.read_excel(
        "Semester_Attendance_Tracker_v6.xlsx", 
...
try:
    ...
    if st.button("💾 Save System Changes permanently"):
        import openpyxl
        wb = openpyxl.load_workbook("Semester_Attendance_Tracker_v5.xlsx")
        ...
        wb.save("Semester_Attendance_Tracker_v5.xlsx")
        st.success("Attendance ledger modifications stored successfully inside Semester_Attendance_Tracker_v5.xlsx!")

except FileNotFoundError:
    st.error("Error: Could not locate your base tracking Excel file in the active folder path. Please verify file version name match.")
